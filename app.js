...
console.log(process.env.S3_BUCKETUSER);
const app = express();
...
mongoose
  .connect(
    `mongodb+srv://${process.env.S3_BUCKETUSER}:${process.env.S3_BUCKETPASS}@cluster0.zktrumw.mongodb.net/${process.env.S3_BUCKETDBN}?retryWrites=true&w=majority`,
    {
